...
public class SNMPTrapSender {
	...
	private String snmpAdapterSNMPEngineID = Config.getInstance().getValue("snmp_engineid");
	private String snmpSecurityName = Config.getInstance().getValue("snmp_securityname");
	private String snmpPrivCypher = Config.getInstance().getValue("snmpPrivCypher");
	private String snmpAuthCypher = Config.getInstance().getValue("snmpAuthCypher");
	...
	public void sendSnmpV3TrapCommand(String trap) {
		...
		try {
			String command = null;
			command = "/usr/bin/snmptrap -v3 -e " + snmpAdapterSNMPEngineID + " -l authPriv -u " + snmpSecurityName
	 ...
	 * Sends the v3 trap
	 */
	private void sendSnmpV3Trap(String trap) {
		try {
			...
			OctetString localEngineId = new OctetString(
					MPv3.createLocalEngineID(new OctetString(snmpAdapterSNMPEngineID)));
			...
			target.setSecurityName(new OctetString(snmpSecurityName));
